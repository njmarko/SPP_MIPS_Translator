...
public:
	...
	* @param pos position in the interference matrix
	*/
	...
	* @param pos position in the interference matrix
	* @param type of the variable
	* @param val value of the MEM variable
	*/
	...
	* @param v const reference to the variable that is intended for printing
	...
	* @param reg name of the register from Regs enumeration
	*/
...
public:
	...
	* @param dst list of destination variables
	* @param src list of source variables
	* @param parent_lab name of the parent label where this instruction belongs
	*/
	...
	* @param src list of source variables
	* @param parent_lab name of the parent label where this instruction belongs
	* @param num number that can appear in certain types of instructions
	*/
	...
	* @param dst list of destination variables
	* @param src list of source variables
	* @param j_label name of the label where this instruction jumps
	* @param parent_lab name of the parent label where this instruction belongs
	*/
	...
	* @param instr pointer to the successor instruction
	*/
	...
	* @param instr pointer to the predecesor instruction
	*/
	...
	* @param vars const reference to a list of pointers of variables
	*/
	...
	* @param v reference to the variable which existance in Def will be checked
	*/
	bool checkVarInDef(Variable& v);

	/**
	* Checks if the variable is in the Use set
	* @param v Variable reference to the variable which existance in Use will be checked
	*/
	...
	* @param val int value associated with the instruction
	*/
	...
	* @param type enum that represents Instruction Type
	*/
...
public:
	...
	* @returns reference to the interference matrix that is represented by a vector of vectors of ints
	*/
	...
	* @param m reference to the new interference matrix
	*/
	...
	* @param v pointer to the list of variable pointers
	*/
